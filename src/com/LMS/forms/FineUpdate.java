 ...
 * @author Hp
 */
public class FineUpdate extends javax.swing.JFrame {

    /**
     * Creates new form FineUpdate
     */
    public FineUpdate() {
        initComponents();
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(member, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(loan, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         String query=" Update fine set loan_id = ? ,Member_id=?, Fine_amount=? where loan_id=?";
         
         PreparedStatement pst = cn.prepareStatement(query);
         
         
         pst.setInt(1, Integer.parseInt(loan.getText()));
         pst.setInt(2, Integer.parseInt(member.getText()));
         pst.setInt(3,Integer.parseInt(amount.getText()));
         pst.setInt(4, Integer.parseInt(loan.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FineUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FineUpdate().setVisible(true);
            }
        });
    }
