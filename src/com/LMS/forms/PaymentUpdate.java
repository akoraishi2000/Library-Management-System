...
public class PaymentUpdate extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PaymentUpdate
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String query=" Update fine_payment set Member_id=?, Payment_amount=? where ID=?";

            PreparedStatement pst = cn.prepareStatement(query);

            pst.setInt(1, Integer.parseInt(member.getText()));
            pst.setInt(2,Integer.parseInt(amount.getText()));
            pst.setInt(3, Integer.parseInt(payment.getText()));
