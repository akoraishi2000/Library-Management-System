...
public class Loan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Loan_ID", "Member_ID", "Book_ID", "Loaning_Date"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        AddLoan obj = new AddLoan();
        obj.setVisible(true);
        
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        LoanUpdating obj = new LoanUpdating();
        obj.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        while(rs.next()){
            ...
            String Loaning_Date = String.valueOf(rs.getTimestamp("loan_date"));
            
            
            String tbData [] = {Loan_ID,Member_ID,Book_ID,Loaning_Date};
