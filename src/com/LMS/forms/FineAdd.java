 ...
 * @author Hp
 */
public class FineAdd extends javax.swing.JFrame {

    /**
     * Creates new form FineAdd
     */
    public FineAdd() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         String query="INSERT INTO fine(Member_id,Loan_id,Fine_amount) VALUES ('"+member.getText()+"','"+loan.getText()+"','"+amount.getText()+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FineAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
